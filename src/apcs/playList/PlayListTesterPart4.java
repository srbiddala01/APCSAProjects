...
public class PlayListTesterPart4 {
    public static void main(String args[]) {
        ...
        System.out.print("max size (20): ");
         try {
             System.out.println(eighties.capacity());
         } catch (Exception e) {
             System.out.println("Error: ");
             e.printStackTrace();
         }
        ...
        //  test remove
         ...
         System.out.println("\nAttempt to add to a full list with a valid index (will throw an Exception)\n");
         try {
             eighties.add(5, "With or Without You");
         } catch (Exception e) {
             System.out.println("Error: ");
             e.printStackTrace();
         }
         ...
         try {
             ...
             String fav = eighties.getFavorite();
             int plays = eighties.getPlays(eighties.indexOf(fav));
             System.out.println("\nThe Favorite song is: " + fav + " with " + plays + " plays.");
         } catch (Exception e) {
             System.out.println("Error: ");
             e.printStackTrace();
         }
